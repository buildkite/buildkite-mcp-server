...
type ListTestsArgs struct {
	...
	MinTimestamp  time.Time `json:"min_timestamp" jsonschema:"Start of the aggregation window in RFC3339 format. When omitted, defaults to the organization's default Test Engine period before the current time."`
	MaxTimestamp  time.Time `json:"max_timestamp" jsonschema:"End of the aggregation window in RFC3339 format. Defaults to the current time when omitted."`
